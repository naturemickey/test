...
def my_range = MAP(RANGE(ONE)(FIVE))(INCREMENT)

println(to_integer(FIRST(my_range)))
println(to_integer(FIRST(REST(my_range))))
println(to_integer(FIRST(REST(REST(my_range)))))
println(to_integer(FIRST(REST(REST(REST(my_range))))))
println(to_integer(FIRST(REST(REST(REST(REST(my_range)))))))
println()

my_range = MAP(RANGE(ONE)(FIVE))(MULTIPLY(TWO))
